#!/usr/bin/env python3
"""Validate a ProjFlow article-note Markdown file and its sidecar."""
import argparse
import json
import re
import sys
...
ALLOWED_META = {"title", "author", "date", "tags", "summary", "id"}
...
def main():
    ...
    for target in LINK_RE.findall(body):
        ...
        if not candidate.exists() and not target.startswith("proj#"):
