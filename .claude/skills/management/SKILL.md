...
启动服务（后端 8809 + 前端 3210）：`bash start_services.sh`。日志 `/tmp/<项目名>-backend.log`、`/tmp/<项目名>-frontend.log`。
...
bash start_services.sh                             # 启动后端 8809 + 前端 3210
curl --noproxy '*' "http://localhost:8809/api/management/tasks?slug=myproject"   # 前端所见看板
